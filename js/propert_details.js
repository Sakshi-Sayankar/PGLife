...
var toggle_interested_success = function (event){
    ...
    if (response.success) {
        var is_interested_image = document.getElementsByClassName("is_interested_image")[0];
        var interested_user_count = document.getElementsByClassName("interested_user_count")[0];
